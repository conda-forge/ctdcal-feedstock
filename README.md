...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ctdcal-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14189&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ctdcal-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ctdcal` can be installed with:

```
conda install ctdcal
```

It is possible to list all of the versions of `ctdcal` available on your platform with:
